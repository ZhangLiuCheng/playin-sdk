...
int H264::init(JNIEnv *env, jobject instance, jint width, jint height, jint rotate, jobject surface) {
    this->width = width;
    this->height = height;
    this->rotate = rotate;
...
int H264::decoding(JNIEnv *env, jobject instance, jbyteArray data) {
...
void H264::updateSurface(JNIEnv *env, jobject surface) {
    this->surface = surface;
    resetNativeWindow(env);
}

void H264::updateRotate(JNIEnv *env, jint rotate) {
...
void H264::resetNativeWindow(JNIEnv *env) {
...
AVFrame* H264::processYuv(AVFrame *yuvFrame) {
...
AVFrame* H264::mallocRGBFrame(int width, int height) {
...
void H264::renderWindow(AVFrame *destFrame, int videoWidth, int videoHeight) {
